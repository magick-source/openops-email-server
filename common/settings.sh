...
export OPENOPS_MAIL_VARIABlES='$MAIL_DIR:$MAIL_HOST:$POSTMASTER_EMAIL:$POSTADMIN_EMAIL:$DB_POSTFIX:$DB_POSTFIX_PASSWORD:$DB_POSTFIXADMIN_PASSWORD:$DB_DEVECOT_PASSWORD:$DB_AMAVIS_PASSWORD:$DB_ROUNDCUBE:$DB_ROUNDCUBE_PASSWORD:$MX_HOSTNAME:$MX_MYNETWORKS:$DB_DOVECOT_PASSWORD:$COOKIEKEY_ROUNDCUBE:$PFADMIN_HOSTNAME:$PFADMIN_SETUP_CHECK:$MX_MAIN_DOMAIN:$WEBMAIL_HOSTNAME:$MX_SPAM_TRUST_NETWORKS:$VIRUS_ADMIN:$VIRUS_ALERT_FROM'
